"""
Django settings for grunt_risk_assesmen_45539 project.
...
ROOT_URLCONF = 'grunt_risk_assesmen_45539.urls'
...
WSGI_APPLICATION = 'grunt_risk_assesmen_45539.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "grunt_risk_assesmen_45539 API",
    "DESCRIPTION": "API documentation for grunt_risk_assesmen_45539 App",
    "VERSION": "v1",
}
